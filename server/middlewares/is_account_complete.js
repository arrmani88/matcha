...
const isAccountComplete = (req, res, next) => {
	dbController.query(
		...
		(err, result) => {
			...
			} else if (result[0].birthday == null || result[0].gender == null || result[0].sexualPreferences == null || result[0].biography == null || result[0].tags == null || result[0].tags.length != 5) {
